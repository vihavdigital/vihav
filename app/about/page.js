            ...
            <section className="relative h-[80vh] flex items-center justify-center overflow-hidden">
                ...
                <div className="container mx-auto px-6 relative z-10 text-center">
                    ...
                    >
                        ...
                        <h1 className="font-serif text-5xl md:text-7xl mb-8 leading-tight text-white drop-shadow-md">
                            The Rise of a <br /> New Name
                        </h1>
                        <p className="text-xl md:text-2xl font-light text-white/80 max-w-3xl mx-auto leading-relaxed drop-shadow-sm">
            ...
            <section className="py-24 px-6 container mx-auto">
                <div className="grid md:grid-cols-2 gap-16 items-center">
                    <motion.div
                        ...
                        transition={{ duration: 0.8 }}
                    >
                        <h2 className="font-serif text-4xl mb-8 text-foreground">An Invitation to a <br /> Better Lifestyle</h2>
                        <div className="space-y-6 text-muted-foreground font-light leading-relaxed">
                            ...
                            <div className="h-px bg-border w-24 my-8" />
                    ...
                    <div className="relative h-[500px] md:h-[600px] bg-secondary border border-border">
                        <img
                            src="https://images.unsplash.com/photo-1600607686527-6fb886090705?q=80&w=1000&auto=format&fit=crop"
                            alt="Luxury Living"
                            className="w-full h-full object-cover opacity-80"
                        />
                        <div className="absolute -bottom-8 -left-8 bg-card p-8 border border-border hidden md:block shadow-xl">
                            <span className="text-4xl font-serif block mb-2 text-gold-400">10+</span>
                            <span className="text-xs uppercase tracking-widest text-muted-foreground">Years of Experience</span>
                        </div>
                    </div>
                </div>
            </section>
            ...
            <section className="py-24 bg-secondary/50">
                <div className="container mx-auto px-6">
                    <div className="max-w-4xl mx-auto text-center">
                        ...
                        <h2 className="font-serif text-4xl md:text-5xl mb-12 text-foreground">The Driving Force</h2>

                        <div className="bg-card border border-border p-8 md:p-12 relative shadow-sm">
                            {/* Quote Icon */}
                            <div className="absolute top-8 left-8 text-gold-400/20 text-8xl font-serif">"</div>

                            <p className="text-lg md:text-xl text-muted-foreground font-light leading-relaxed mb-8 relative z-10">
                            ...
                            <div>
                                <h3 className="text-xl font-serif text-foreground">Mr. Kunal Rajeshkumar Arya</h3>
                                <p className="text-gold-400 text-sm uppercase tracking-widest mt-2">Director, Vihav Group</p>
                                <p className="text-muted-foreground text-xs mt-1">Board of Directors, Vadodara CREDAI</p>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <section className="py-24 px-6 container mx-auto">
                <div className="grid md:grid-cols-2 gap-8">
                    ...
                    <motion.div
                        ...
                        viewport={{ once: true }}
                        className="bg-card p-12 border-t-2 border-gold-400 group hover:bg-secondary transition-colors shadow-sm"
                    >
                        <h3 className="font-serif text-3xl mb-6 text-foreground group-hover:text-gold-600 transition-colors">Our Mission</h3>
                        <p className="text-muted-foreground leading-relaxed text-sm md:text-base mb-6 uppercase tracking-wide font-medium">
                    ...
                    <motion.div
                        ...
                        className="bg-card p-12 border-t-2 border-border group hover:border-gold-400 hover:bg-secondary transition-colors shadow-sm"
                    >
                        <h3 className="font-serif text-3xl mb-6 text-foreground group-hover:text-gold-600 transition-colors">Our Vision</h3>
                        <p className="text-muted-foreground leading-relaxed text-sm md:text-base mb-6 uppercase tracking-wide font-medium">
