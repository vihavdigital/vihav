    ...
    return (
        <>
            ...
            <motion.div
                ...
                className={`fixed top-0 left-0 w-6 h-6 bg-white mix-blend-difference rounded-full pointer-events-none z-[10000] shadow-sm hidden md:block ${!hasMoved ? 'opacity-0' : 'opacity-100'} transition-opacity duration-300 will-change-transform`}
            />
            ...
            <main className="min-h-screen bg-[#0a1811] text-[#e8e6d9] selection:bg-emerald-500 selection:text-white overflow-hidden md:cursor-none">
                ...
                <section className="relative h-screen w-full overflow-hidden">
                    <motion.div style={{ y: heroY, opacity: opacityHero }} className="absolute inset-0 z-0">
                        ...
                        <img
                            src="https://images.unsplash.com/photo-1463936575829-25148e1db1b8?q=80&w=2600&auto=format&fit=crop"
                ...
                <section className="py-32 relative bg-[#0a1811] overflow-hidden">
                    ...
                    <div className="container mx-auto px-6 relative z-10">
                        ...
                        <div className="absolute top-0 left-0 w-full overflow-hidden pointer-events-none opacity-5 leading-none select-none">
                            <motion.div
                                ...
                                className="flex text-[20rem] font-serif whitespace-nowrap text-white"
                            >
                        ...
                        <div className="flex flex-col lg:flex-row items-center gap-20 pt-20">
                            {/* Text Column (Left) with Parallax */}
                            <motion.div style={{ y: textParallax }} className="lg:w-1/2 space-y-12 relative z-10">
                                <h2 className="text-5xl md:text-8xl font-serif leading-[0.85]">
                                    Not Built. <br /> <span className="text-emerald-500 italic block pl-20">Nurtured.</span>
                                </h2>
                                <div className="space-y-8 text-xl font-light text-gray-300 leading-relaxed font-serif pl-4 border-l border-emerald-500/30">
                                    <p>
                                ...
                                <div className="grid grid-cols-2 gap-12 pt-8">
                                    <div className="group">
                                        <h4 className="text-6xl text-white font-serif mb-2 group-hover:text-emerald-400 transition-colors">26</h4>
                                        <span className="text-xs uppercase tracking-[0.2em] text-gray-500">Exclusive Families</span>
                                    </div>
                                    <div className="group">
                                        <h4 className="text-6xl text-white font-serif mb-2 group-hover:text-emerald-400 transition-colors">5k+</h4>
                            ...
                            <motion.div style={{ y: imgParallax }} className="lg:w-1/2 relative">
                                <div className="relative z-10 rounded-full overflow-hidden border border-white/10 aspect-[3/4] w-[80%] mx-auto shadow-2xl shadow-emerald-900/30">
                                    <img
                                ...
                                {/* Decorative "Stamp" */}
                                <div className="absolute -bottom-10 -right-0 lg:-right-10 bg-emerald-500 text-[#0a1811] w-40 h-40 rounded-full flex items-center justify-center animate-spin-slow shadow-xl z-20 hidden md:flex">
                ...
                <section className="py-32 bg-black overflow-hidden relative">
                    ...
                    <div className="container mx-auto px-6 mb-16 flex flex-col md:flex-row justify-between items-end gap-8">
                        ...
                        <div className="flex gap-4">
                            <button onClick={prevSlide} className="w-14 h-14 flex items-center justify-center rounded-full border border-white/20 hover:bg-white hover:text-black transition-all hover:scale-110">
                                <ChevronLeft size={24} />
                            </button>
                            <button onClick={nextSlide} className="w-14 h-14 flex items-center justify-center rounded-full border border-white/20 hover:bg-white hover:text-black transition-all hover:scale-110">
                                <ChevronRight size={24} />
                            </button>
                        </div>
                    </div>

                    <div className="relative h-[60vh] md:h-[80vh] w-full group">
                            ...
                            >
                                ...
                                <div className="absolute inset-0 bg-gradient-to-t from-black via-black/20 to-transparent p-6 md:p-20 flex flex-col justify-end">
                                    <motion.div
                                        ...
                                        className="container mx-auto border-l-2 border-emerald-500 pl-8"
                                    >
                ...
                <section className="py-40 bg-[#06120c] relative overflow-hidden">
                    ...
                    <div className="container mx-auto px-6">
                        <motion.div
                            ...
                            className="relative max-w-6xl mx-auto bg-gradient-to-r from-emerald-950/20 to-[#0a1811] border border-emerald-900/30 rounded-[3rem] p-12 lg:p-20 overflow-hidden group shadow-2xl"
                        >
                            ...
                            <div className="grid md:grid-cols-3 gap-16 items-center relative z-10">
                                <div className="text-center md:text-left space-y-4">
                                    <div className="w-20 h-20 bg-emerald-900/30 rounded-full flex items-center justify-center mb-6 text-emerald-400 mx-auto md:mx-0 shadow-lg shadow-emerald-900/10 border border-white/5">
                                        <Wind size={36} strokeWidth={1.5} />
                                    </div>
                                    <h3 className="text-3xl font-bold text-white font-serif">Dual Kitchens</h3>
                                    <p className="text-base text-gray-500 leading-relaxed font-light">Gourmet & Utility. Separate spaces for hosting and preparation.</p>
                                </div>

                                <div className="relative h-[400px] flex items-center justify-center">
                                    {/* Abstract Floorplate Visual */}
                                    <motion.div
                                        animate={{ rotate: 360 }}
                                    ...
                                    <div className="relative w-72 h-72 border border-emerald-500/30 rotate-45 flex items-center justify-center backdrop-blur-sm z-10 bg-[#0a1811]/80 shadow-2xl skew-x-6 hover:skew-x-0 transition-transform duration-700">
                                        <div className="text-center -rotate-45">
                                            <span className="block text-7xl font-serif text-white mb-2">1</span>
                                ...
                                <div className="text-center md:text-right space-y-4">
                                    <div className="w-20 h-20 bg-emerald-900/30 rounded-full flex items-center justify-center mb-6 text-emerald-400 mx-auto md:ml-auto shadow-lg shadow-emerald-900/10 border border-white/5">
                                        <Leaf size={36} strokeWidth={1.5} />
                                    </div>
                                    <h3 className="text-3xl font-bold text-white font-serif">45,000 Sq. Ft. Plot</h3>
                                    <p className="text-base text-gray-500 leading-relaxed font-light">An expansive ground for just 26 families, ensuring low density and high serenity.</p>
                                </div>
                            </div>
                        </motion.div>
                    </div>
                ...
                {/* 5. LOCATION & CONTACT: CREAM SECTION */}
                <section className="py-32 bg-[#e8e6d9] text-[#0a1811]">
                    <div className="container mx-auto px-6">
                        <div className="grid lg:grid-cols-2 gap-20">
                            <div className="flex flex-col justify-center">
                                <span className="text-[#0a1811]/60 uppercase tracking-widest text-sm mb-6 block">The Address</span>
                                <h2 className="text-5xl md:text-8xl font-serif mb-12 text-[#0a1811] leading-[0.9]">New Alkapuri's<br /> Greenest Corner</h2>
                                <div className="space-y-10 text-xl font-serif">
                                    <div className="flex items-start group cursor-pointer border-b border-[#0a1811]/10 pb-8">
                                        <MapPin className="mr-8 mt-1 text-emerald-700 transition-transform group-hover:scale-125" size={28} />
                                        <div>
                                    ...
                                    <div className="flex items-start group cursor-pointer border-b border-[#0a1811]/10 pb-8">
                                        <Phone className="mr-8 mt-1 text-emerald-700 transition-transform group-hover:scale-125" size={28} />
                                        <div>
                                ...
                                <div className="mt-16">
                                    <Button className="bg-[#0a1811] text-white hover:bg-emerald-800 px-12 py-8 rounded-full text-xl transition-all shadow-2xl hover:shadow-xl hover:-translate-y-1 w-full md:w-auto">
                                        Schedule a Private Viewing
                                    </Button>
                                </div>
                            </div>
                            <div className="relative h-[800px] bg-emerald-900 rounded-[2rem] overflow-hidden flex items-center justify-center group shadow-2xl border border-emerald-500/20 z-0">
                                {/* Custom Luxury Map for Niwa */}
                                <LuxuryMapWrapper activeProject={keystoneNiwa} />

                                <div className="absolute bottom-10 left-10 pointer-events-none z-[400]">
