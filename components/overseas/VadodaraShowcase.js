        ...
        <section className="py-24 bg-neutral-950 relative overflow-hidden">
            ...
            <div className="container mx-auto px-6 relative z-10">
                <div className="text-center mb-12">
                    ...
                    <h2 className="text-4xl md:text-5xl font-serif text-white mb-4">Vadodara Calling</h2>
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                    {images.map((img, idx) => (
                        <motion.div
                            ...
                            className="group relative h-80 rounded-xl overflow-hidden border border-white/10"
                        >
                            <img
                                src={img.url}
                                alt={img.caption}
