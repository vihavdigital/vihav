...
export const PROJECTS = [
  {
    id: "keystone-48",
    coordinates: { lat: 22.2858, lng: 73.1095 },
    locationHighlights: ["Vasna-Bhayli Road", "Near Nilamber Palms", "Bhayli"],
    seoTags: ["4B2HK Apartments Vadodara", "5B2HK Penthouses Bhayli", "Luxury Living Vadodara"],
    srd: "keystone-48-srd-placeholder", // Use a placeholder or known ID if available
    link: "/projects/keystone-48",
    slug: "keystone-48",
    title: "Keystone 48",
    tagline: "4B2HK LUXURIOUS APARTMENTS & 5B2HK PENTHOUSES",
    logo: "/images/project-images/project-logos/keystone-48-logo.svg",
    category: "Residential",
    location: "Vasna-Bhayli Road, Bhayli",
    carpetArea: "Spacious 4B2HK Residences",
    type: "4B2HK Apartments & 5B2HK Penthouses",
    price: "Price on Request",
    status: "Upcoming",
    progress: 95,
    reraId: "PR/GJ/VADODARA/VADODARA/Others/RAA11818/220523",
    reraLink: "https://gujrera.gujarat.gov.in/",
    phone: "+91 7434 962 962",
    email: "keystone48@vihav.com",
    description: "Keystone 48 offers luxurious 4B2HK apartments and 5B2HK penthouses in the prime location of Bhayli. Designed for those who seek exclusivity, privacy, and a premium lifestyle with world-class amenities.",
    vision: "Where the Exclusive is Ordinary",
    ...
    features: [
      "Only 1 or 2 Apartments per Floor",
      "Personal Foyer",
      "Attached Servant Quarters",
      "Open Terrace in Penthouses",
    ],
    ...
    highlights: [
      {
        ...
        title: "Exclusivity",
        label: "Low Density",
        description: "Only 1 or 2 apartments per floor for maximum privacy.",
      },
      {
        icon: "Users",
        title: "Community",
        label: "Elite Neighborhood",
        description: "Small elite community with like-minded neighbours.",
      },
      {
        icon: "Home",
        title: "Spacious",
        label: "4B2HK Residences",
        description: "Ultra-spacious residences with attached servant quarters.",
      },
      {
        icon: "Star",
        title: "Lifestyle",
        label: "Premium Amenities",
        description: "World-class lifestyle amenities including pool and gym.",
      },
    ],
    amenitiesList: [
      { icon: "Waves", label: "Swimming & Splash Pool" },
      { icon: "Trees", label: "Garden & Sitting Area" },
      ...
      { icon: "Smile", label: "Children Play Area" },
    ],
    specifications: [
      {
        category: "Structure",
      ...
      {
        category: "Flooring",
        items: ["Italian floor in living/kitchen/dining", "Double Charged Vitrified Tiles in rooms"],
      },
      {
        category: "Bathrooms",
        items: ["Designer Ceramic Tiles", "Premium Counter for Basins", "Kohler/ROCA Fittings"],
      },
      {
        category: "Kitchen",
        items: ["Premium Stone Platform", "Designer Ceramic Tiles Dado", "Wash Area with Natural Stone"],
      },
      {
        category: "Others",
        items: ["Veneer Paneling on Main Door", "Powder Coated Aluminum/UPVC Windows", "Concealed Copper Wiring"],
      },
    ],
    connectivity: [
      { label: "Bright Day School", time: "2 Mins" },
      { label: "Nilamber Palms", time: "1 Min" },
      { label: "Bhayli Main Road", time: "2 Mins" },
    ],
    address: "B/S. Nilamber Palms, Nr. Bright Day School (CBSE), Vasna-Bhayli Road, Vadodara – 391410",
    coordinates: { lat: 22.2858, lng: 73.1095 },
    googleMapsLink: "https://maps.google.com/?q=Keystone+48",
  ...
  {
    id: "keystone-select",
    coordinates: { lat: 22.2900, lng: 73.1261 },
    locationHighlights: ["Near Navrachana University", "75m Ring Road", "Bhayli"],
    seoTags: ["Luxury Apartments Bhayli", "Penthouse Vadodara", "4BHK Flats"],
  ...
  {
    id: "keystone-51",
    coordinates: { lat: 22.2599, lng: 73.1192 },
    locationHighlights: ["Bhayli", "Off 75m Main Road", "Near NX Lifestyle"],
    seoTags: ["4BHK Villas Bhayli", "Luxury Villas Vadodara", "Bungalows"],
  ...
  {
    id: "keystone-niwa",
    coordinates: { lat: 22.3160, lng: 73.1480 },
    locationHighlights: ["New Alkapuri", "Near Skyvillas", "Gotri"],
    seoTags: ["4BHK Apartments Gotri", "Garden Apartments Vadodara", "Luxury Living"],
  ...
  },
  {
    ...
    coordinates: { lat: 22.3165, lng: 73.1485 },
    locationHighlights: ["New Alkapuri", "Gotri", "30m Main Road"],
    seoTags: ["5BHK Flats Vadodara", "Skyvillas", "Penthouse New Alkapuri"],
...

  {
    id: "vihav-cbd-res",
    coordinates: { lat: 22.2599, lng: 73.1192 },
    locationHighlights: ["Vasna-Bhayli Road", "Near Bright School"],
    seoTags: ["4BHK Flats Bhayli", "Penthouse Vadodara", "CBD Residential"],
  ...
  },
  {
    ...
    coordinates: { lat: 22.2500, lng: 73.1900 },
    locationHighlights: ["Tarsali", "Near Pratham Paradise", "Makarpura"],
    seoTags: ["3BHK Duplex Tarsali", "Villas Vadodara", "Residential Project"],
  ...
  },
  {
    id: "vihav-elinor",
    coordinates: { lat: 22.3160, lng: 73.1480 },
    locationHighlights: ["New Alkapuri", "Gotri", "Behind Narayan Garden"],
    seoTags: ["3BHK Flats New Alkapuri", "4BHK Apartments Vadodara", "Penthouse"],
  ...
  },
  {
    ...
    coordinates: { lat: 22.2900, lng: 73.1000 },
    locationHighlights: ["Bhayli", "Behind Akshar Public School", "Sevasi"],
    seoTags: ["3BHK Flats Bhayli", "Family Homes Vadodara", "Affordable Luxury"],
  ...
  {
    id: "skyone",
    coordinates: { lat: 22.2600, lng: 73.1200 },
    locationHighlights: ["Vasna Bhayli Canal Road", "Opp Nayara Pump"],
    seoTags: ["Shops Bhayli", "Commercial Space Vadodara", "Offices"],
  ...
  {
    id: "keystone-mansion",
    coordinates: { lat: 22.3150, lng: 73.1450 },
    locationHighlights: ["Gotri", "New Alkapuri"],
    seoTags: ["4BHK Flats Gotri", "Premium Apartments Vadodara"],
    slug: "keystone-mansion",
    link: "/projects/keystone-mansion", // Fixed missing link
    title: "Keystone Mansion",
    logo: "/images/project-images/project-logos/keystone-mansons-logo.svg",
    status: "Completed",
    category: "Residential",
  ...
  },
  {
    ...
    logo: "/images/project-images/project-logos/keystone-mansons2-logo.svg",
    status: "Completed",
    category: "Residential",
    location: "Khanpur, Sevasi",
  ...
  {
    id: "vs-monolith",
    coordinates: { lat: 22.2700, lng: 73.1556 },
    locationHighlights: ["Atladra-Padra Road", "Vertex City"],
    seoTags: ["Commercial Showrooms Atladra", "Offices Padra Road", "Shops"],
    ...
    galleryImages: [
      ...
      "/images/project-images/projects/monolith-project-images/gallery/vihav-monolith-commercial-fountain-foyar-cam25-a-scaled.webp",
      "/images/project-images/projects/monolith-project-images/gallery/vihav-monolith-commercial-foyer-a-scaled.webp",
      "/images/project-images/projects/monolith-project-images/gallery/vihav-monolith-commercial-left-corner-night-a-scaled.webp",
      "/images/project-images/projects/monolith-project-images/gallery/vihav-monolith-conference-room-cam-scaled.webp",
      "/images/project-images/projects/monolith-project-images/gallery/vihav-monolith-gym-cam-scaled.webp",
      "/images/project-images/projects/monolith-project-images/gallery/vihav-monolith-waiting-area-cam-scaled.webp",
    ],
    floorPlans: [
      {
        id: "fp-ground",
  ...
  },
  {
    id: "supremus-iii",
    coordinates: { lat: 22.2600, lng: 73.1200 },
    locationHighlights: ["Vasna Bhayli Main Road", "Nr. DMart", "Strategic Location"],
    seoTags: ["Commercial Offices Bhayli", "Showrooms Vadodara", "Business Hub"],
  ...
  },
  {
    ...
    slug: "cbd-commercial",
    coordinates: { lat: 22.2599, lng: 73.1192 },
    locationHighlights: ["Vasna-Bhayli Road", "Central Business District"],
    seoTags: ["Corporate Offices Bhayli", "Shops Vadodara", "CBD Commercial"],
    title: "Vihav CBD",
    logo: "/images/project-images/project-logos/cbd-logo.svg",
    category: "Commercial",
    location: "Bhayli Cross Road, Vadodara",
  ...
  {
    id: "vihav-supremus-2",
    coordinates: { lat: 22.2810, lng: 73.1490 },
    locationHighlights: ["Vasna 30m Road", "Near D-Mart"],
    seoTags: ["Commercial Showrooms Vasna", "Offices Vadodara", "Shops"],
  ...
  },
  {
    id: "vtc",
    coordinates: { lat: 22.2600, lng: 73.1200 },
    locationHighlights: ["Vasna Bhayli Canal Road", "Nr Essar Pump"],
    seoTags: ["Commercial Trade Center", "Shops Bhayli", "Offices Vadodara"],
  ...
  {
    id: "supremus",
    coordinates: { lat: 22.3153, lng: 73.1427 },
    locationHighlights: ["Gotri Road", "New Alkapuri", "Strategic Business Hub"],
    seoTags: ["Commercial Property Gotri", "Offices for Sale Vadodara", "Showrooms"],
  ...
  {
    id: "elite-square",
    coordinates: { lat: 22.2810, lng: 73.1498 },
    locationHighlights: ["Sun Pharma Road", "Near Pratham Upvan"],
    seoTags: ["Shops Sun Pharma Road", "Commercial Vadodara", "Showrooms"],
    srd: "62a6fdd7ed23e91a321dac81", // VIHAV ELITE SQUARE
    link: "/projects/elite-square/",
    slug: "elite-square",
    title: "Elite Square",
    logo: "/images/project-images/project-logos/elite-square-logo.svg",
    status: "Completed",
    category: "Commercial",
  ...
  },
  {
    ...
    slug: "ensign",
    title: "Ensign",
    logo: "/images/project-images/project-logos/ensign-logo.svg",
    status: "Completed",
    category: "Commercial",
    location: "Gotri",
  ...
  },
  {
    ...
    slug: "excellus",
    title: "Excellus",
    logo: "/images/project-images/project-logos/excelus-logo.svg",
    status: "Completed",
    category: "Commercial",
